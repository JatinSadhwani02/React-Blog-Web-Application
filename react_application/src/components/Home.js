...
<div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" >
    ...
    <div className="carousel-inner">
      ...
      <div className="carousel-item">
        <img src={"images/thumbnail6.jpeg"} className="d-block w-100" alt="..." style={{height:'500px'}} />
      </div>
    </div>
  ...
  <div className="album py-5 bg-light">
    <div className="container">
      ...
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div className="col">
          <div className="card shadow-sm">
            <img src={"images/thumbnail4.jpeg"} className="d-block w-100" alt="..." style={{height:'200px'}} />
            <div className="card-body">
              <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        ...
        <div className="col">
          <div className="card shadow-sm">
            <img src={"images/thumbnail5.jpg"} className="d-block w-100" alt="..." style={{height:'200px'}} />
            <div className="card-body">
              <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        ...
        <div className="col">
          <div className="card shadow-sm">
            <img src={"images/thumbnail6.jpeg"} className="d-block w-100" alt="..." style={{height:'200px'}} />
            <div className="card-body">
              <p className="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
